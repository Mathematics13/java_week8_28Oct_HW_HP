...
public class Program5_Palindrome
{
    public static void main(String[] args)
    {
        ...
        System.out.println(isPalindrome(11212));     //Should return false because the reverse of 11212 != 21211
    }

    public static boolean isPalindrome(int number)
    {
        if (number < 0)                                    //Handle negative numbers by converting them to positive
        {
            number = Math.abs(number);                   //absolute number is the modulus showing only positive
        }
 ...
 *otherwise it should return false. Check the tips below for more info about palindromes.
